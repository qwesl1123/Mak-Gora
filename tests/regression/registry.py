...
from .test_lifecycle_expiration import (
    scenario_lifecycle_queue_background_expiration,
    scenario_lifecycle_prep_idle_expiration,
    scenario_lifecycle_prep_absolute_expiration,
    scenario_lifecycle_combat_idle_expiration,
    scenario_lifecycle_combat_absolute_expiration,
    scenario_lifecycle_ended_grace_period,
    scenario_lifecycle_authoritative_cleanup,
    scenario_lifecycle_busy_match_skipped,
    scenario_lifecycle_disconnect_waits_cooperatively,
    scenario_lifecycle_registry_lock_not_held_during_work,
    scenario_lifecycle_one_sweeper_only,
    scenario_lifecycle_capacity_recovery,
    scenario_lifecycle_cleanup_failure_isolation,
    scenario_lifecycle_partial_setup_failure_detaches_and_retries,
...
from .test_items_challenger import (
    ...
    scenario_deaths_bargain_direct_multihit_aoe_and_dot_contract,
    scenario_deaths_bargain_consumption_and_noneligible_actions,
    scenario_deaths_bargain_excluded_damage_sources,
)
from .test_next_offense import (
    scenario_next_offense_multiple_effects_stack_on_same_cast,
    scenario_next_offense_multiple_effects_are_order_independent,
    scenario_next_offense_multiple_effects_consume_on_failed_damage_outcomes,
    scenario_next_offense_multiple_effects_preserve_on_rejected_actions,
    scenario_next_offense_multiple_effects_multihit_contract,
    scenario_next_offense_multiple_effects_aoe_contract,
    scenario_next_offense_does_not_scale_strike_again,
    scenario_multiple_next_offense_effects_do_not_scale_strike_again,
    scenario_strike_again_basis_preserves_ordinary_outgoing_modifiers,
    scenario_strike_again_empowerment_order_independence,
    scenario_strike_again_multihit_parent_contract,
    scenario_next_offense_snapshot_validation_rejects_malformed_metadata,
    scenario_direct_damage_classifier_inference_and_overrides,
    scenario_direct_damage_classifier_rejects_malformed_metadata,
    scenario_pure_dot_abilities_preserve_next_offense_effects,
    scenario_direct_plus_dot_ability_consumes_next_offense_effects,
...
from .test_periodic_items import (
    ...
    scenario_scourgelord_item_effect_docs_and_handler_validation,
    scenario_scourgelord_hp_cost_exclusions_and_refresh,
    scenario_scourgelord_schedule_order_and_periodic_timing,
    ...
    scenario_vial_of_shadows_mindgames_converts_all_entities,
    scenario_vial_of_shadows_ignores_miss_and_redirect,
...
from .test_damage_pipeline import (
    ...
    scenario_dragonwrath_duplicate_log_is_viewer_relative,
    ...
    scenario_mindgames_drain_life_damage_derived_healing,
    scenario_mindgames_fury_of_azzinoth_damage_derived_healing,
    ...
    scenario_mindgames_player_on_hit_healing_is_terminal,
    scenario_azzinoth_strike_again_deals_secondary_damage,
    scenario_fury_of_azzinoth_cannot_miss,
    scenario_fury_of_azzinoth_respects_armor,
...
from .test_dots_hots import (
    ...
    scenario_mindgames_player_hot_uses_live_tick_state,
    scenario_mindgames_dot_precedes_player_hot_and_lifesteal,
    scenario_mindgames_excludes_autonomous_pet_healing,
    scenario_player_produced_healing_boundaries_fail_closed,
...
from .test_pets import (
    ...
    scenario_mindgames_astral_explosion_entity_packets,
...
from .test_ui_docs_metadata import (
    ...
    scenario_demonic_circle_teleport_uses_exact_log_tooltip,
...
from .test_classes_abilities import (
    ...
    scenario_player_produced_healing_entity_result_contract,
    scenario_mindgames_kill_command_entity_conversion,
    scenario_mindgames_direct_healing_pipeline_and_terminal_conversion,
    ...
    scenario_mindgames_aoe_snapshot_survives_immune_champion,
    scenario_mindgames_converted_aoe_pet_hit_still_applies_dot,
    scenario_mindgames_player_dot_tick_on_pet_converts,
    ...
    scenario_avenging_wrath_outgoing_empowerment_logs,
