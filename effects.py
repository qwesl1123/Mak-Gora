...
_EFFECT_PANEL_DESCRIPTION_BY_NAME: Dict[str, str] = {
    ...
    "Flame Shock": "Able to cast Flame Shock (if not on cooldown).",
    "Frost Shock": "Able to cast Frost Shock (if not on cooldown).",
