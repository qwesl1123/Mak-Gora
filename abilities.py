...
ABILITIES = {
    ...
    "cleave": {
        ...
        "cooldown": 6,
        "classes": ["warrior"],
        "resource_gain_on_dealt": {"rage": "damage"},
    },
    "ignore_pain": {
        "name": "Ignore Pain",
        "cost": {"rage": 5},
    ...
    "iceblock": {
        ...
        "dice": None,
        "tags": ["defense", "spell"],
        "allow_while_crowd_control": True,
        "school": "magical",
        "subschool": "frost",
    ...
    "shadowfiend": {
        ...
        "summon_log": "summons a Shadowfiend.",
        "display_color": "#FFFFFF",
        "cost": {"mp": 20},
        "dice": None,
        "tags": ["spell", "defense"],
    ...
    "wildfire_bomb": {
        ...
        "classes": ["hunter"],
        "self_effects": [
            {"id": "arcane_surge", "duration": 3, "log": "{actor} has Arcane Surge!", "separate_log": True}
        ],
    ...
    "freezing_trap": {
        ...
        "classes": ["hunter"],
        "target_effects": [
            {"id": "freezing_trap_freeze", "duration": 2, "log": "freezes the enemy in place."}
        ],
    },
    "disengage": {
        "name": "Disengage",
    ...
    "raptor_strike": {
        ...
        "cooldown": 8,
        "classes": ["hunter"],
        "requires_effect": "raptor_strike_proc",
        "consume_effect": "raptor_strike_proc",
        "pet_command": "special",
    },
    ...
    "kill_command": {
        ...
        "cooldown": 6,
        "classes": ["hunter"],
        "requires_active_pet": True,
        "pet_command": "special",
        "pet_heal": {"scaling": {"atk": 0.4}, "dice": {"type": "d4", "power_on": "roll"}},
    },
    "multi_shot": {
        "name": "Multi-Shot",
        "display_color": "#AAD372",
    ...
    "lightning_bolt": {
        ...
        "cooldown": 0,
        "classes": ["shaman"],
        "on_hit_cooldown_resets": [
            {"ability_id": "earth_shock", "chance": 0.15},
            {"ability_id": "flame_shock", "chance": 0.10},
            {"ability_id": "frost_shock", "chance": 0.05},
        ],
    },
    "healing_stream": {
        "name": "Healing Stream",
    ...
    "astral_shift": {
        ...
        "subschool": "arcane",
        "cooldown": 15,
        "requires_actor_hp_below": 0.5,
        "requires_actor_hp_below_log": "Astral Shift can only be used below 50% HP.",
        "classes": ["shaman"],
    ...
    "mana_tide_totem": {
        ...
        "display_color": "#0070DD",
        "summon_pet_id": "mana_tide_totem",
        "summon_log": "summons Mana Tide Totem.",
        "cost": {"mp": 10},
        "dice": None,
        "tags": ["spell", "utility"],
        "school": "magical",
    ...
    "capacitor_totem": {
        ...
        "display_color": "#0070DD",
        "summon_pet_id": "capacitor_totem",
        "summon_log": "summons Capacitor Totem.",
        "cost": {"mp": 20},
        "dice": None,
        "tags": ["spell", "control"],
        "school": "magical",
