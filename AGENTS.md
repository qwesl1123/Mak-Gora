...
This section characterizes current behavior for migration safety only. It does not endorse the currently ambiguous Mindgames/Cyclone treatment of item healing, lifesteal targets, or pet-sourced healing as permanent design policy.
