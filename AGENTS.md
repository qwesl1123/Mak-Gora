...
* Callers currently own formulas, dice, eligibility, timing, Mindgames decisions, log wording, and combat-total attribution. Combat totals credit the actual HP delta; log wording currently mixes requested and actual amounts per mechanic and must not be standardized incidentally.
